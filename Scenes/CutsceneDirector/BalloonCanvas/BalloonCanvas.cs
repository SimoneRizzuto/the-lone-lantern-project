...
public partial class BalloonCanvas : CanvasLayer
{
  ...
  private async void UpdateDialogue()
  {
    ...
    var portraitNameFormat = $"{dialogueLine.Character.ToLower()}/{dialogueLine.Character.ToLower()}_{tag?.ToLower()}";

    var portraitPath = $"res://Scenes/CutsceneDirector/BalloonCanvas/Portraits/{portraitNameFormat}.png";
